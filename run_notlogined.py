...
scripts_dir = 'C:\\testicashapi\\NTest_Case\\ICPAPI'
...
process = subprocess.Popen('C:\\IcashPost\\ICPAPIVS\\CK02\\ConsoleApp1\\bin\\Debug\\ConsoleApp1.exe', shell=True)
...
html_template = ("<html>"
                 ...
                 "</head>"
                 "<body>"
                 "<h1>ICP API NotLogined Test Report</h1>"
                 f"<p><strong>Total Scripts:</strong> {total_count}</p>"
                 f"<p><strong>Passed Scripts:</strong> {pass_count}</p>"
                 f"<p><strong>Failed Scripts:</strong> {fail_count}</p>"
                 f"<p><strong>Pass Percentage:</strong> {pass_percentage:.2f}%</p>"
